...
export const createCourse = (formData) => async (dispatch) => {
  try {
    ...
    //title,des,category,createdby
    dispatch({ type: "createCourseRequest" });
    const data = await axios.post(`${server}/createcourse`, formData, config);

    dispatch({ type: "createCourseSuccess", payload: data.data.message });
  } catch (error) {
    dispatch({
...
export const deleteCourse = (id) => async (dispatch) => {
  try {
    ...
    dispatch({ type: "deleteCourseSuccess", payload: data.data.message });
  } catch (error) {
    dispatch({
...
export const addLecture = (id, formData) => async (dispatch) => {
  try {
    ...
    dispatch({ type: "addLectureSuccess", payload: data.data.message });
  } catch (error) {
    dispatch({
      type: "addLectureFail",
      payload: error.response.data.message,
...
export const deleteLecture = (courseId, lectureId) => async (dispatch) => {
  try {
    ...
    dispatch({ type: "deleteLectureSuccess", payload: data.data.message });
  } catch (error) {
    dispatch({
